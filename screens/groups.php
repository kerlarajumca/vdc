...
$courses=mysqli_query($conn,"select G.id,G.group_name,G.course_id,C.course from groups G left join courses C on C.id=G.course_id");

if(isset($_POST['submit']))
{
    $group=$_POST['group'];
    $course=$_POST['course'];
    if(mysqli_query($conn,"Insert into groups(course_id,group_name) values($course,'$group')"))
    {
