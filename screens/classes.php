...
$courses=mysqli_query($conn,"select G.group_name,C.course,CL.id,CL.class_name from classes CL left join courses C on CL.course_id=C.id left join groups G on CL.group_id=G.id");
...
if(isset($_POST['submit']))
{
    ...
    $course=$_POST['course'];
    $class=$_POST['class'];
    if(mysqli_query($conn,"Insert into classes(course_id,group_id,class_name) values($course,$group,'$class')"))
    {
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                    ...
                    <div class="col-6">
                        <select name="course" placeholder="Select Course Name" class="form-control course1" id="course" required />
